...
<section>
  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        <li class="active"><a href="dunno.jsp"><i class="fa fa-credit-card"></i> <span>Billing</span></a></li>
        <li><a href="index.html"><i class="fa fa-list-alt"></i> <span>Fast Posting</span></a></li>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-usd"></i> Cashiering</h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="cashiering.jsp">Cashiering</a></li>
