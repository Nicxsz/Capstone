...
<section>
  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        <li class="active"><a href="dunno.jsp"><i class="fa fa-female"></i> <span>Housekeeping</span></a></li>
        <li><a href="index.html"><i class="fa fa-ban"></i> <span>Out of Order</span></a></li>
        <li><a href="index.html"><i class="fa fa-inbox"></i> <span>Room History</span></a></li>
        <li><a href="index.html"><i class="fa fa-puzzle-piece"></i> <span>Occupancy Graph</span></a></li>
        <li><a href="index.html"><i class="fa fa-gears"></i> <span>Maintenance</span></a></li>
  ...
  <div class="mainpanel">
      ...
      <div class="header-left">
        ...
        <div class="topnav">
            ...
            <ul class="nav nav-horizontal">
                ...
                <li class="active"><a href="room.jsp"><i class="fa fa-home"></i> <span>Room Management</span></a></li>
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Room Management</h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="cashiering.jsp">Room Management</a></li>
